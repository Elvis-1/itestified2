  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        behavior: HitTestBehavior
            .opaque, // This makes sure taps pass through to the GestureDetector
        child: Align(
            alignment: Alignment.bottomCenter,
            child: GestureDetector(
              onTap:
                  () {}, // Empty callback to prevent taps inside from closing
              child: Container(
                height: 651,
                decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          ...
          GestureDetector(
            ...
            child: likeOrShare(AppIcons.deleteIcon, "Delete Post",
                containerColor: themeProvider.themeData.colorScheme.onSurface,
                width: 15),
          ),
          lineWidget(
              width: double.infinity,
