            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  textWidget('Welcome to iTestified! ',
                      fontSize: 15, color: AppColors.textColor),
                  SizedBox(
                    height: 15.h,
                  ),
                  textWidget("2. Use of the service",
                      color: AppColors.white, fontSize: 17.sp),
                  SizedBox(
                    height: 15.h,
                  ),
                  ...
                  terms('Impersonate another person or entity.'),
                  terms(
                  ...
                  textWidget("3. Testimony Submissions and Content Guidelines",
                      color: AppColors.white, fontSize: 17.sp),
                  SizedBox(
                    height: 10.h,
                  ),
                  ...
                  textWidget("5. Content and intellectual property",
                      color: AppColors.white, fontSize: 17.sp),
                  SizedBox(
                    height: 10.h,
                  ),
